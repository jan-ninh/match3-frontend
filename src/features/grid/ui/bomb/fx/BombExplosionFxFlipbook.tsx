// src/features/grid/ui/bomb/fx/BombExplosionFxFlipbook.tsx
...
export function BombExplosionFxFlipbook({ bursts, width, zIndex = 88, reducedMotionHint }: Omit<BombExplosionFxLayerProps, 'mode'>) {
